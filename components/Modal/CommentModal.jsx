...
const CommentModal = ({ item, setOpenModal }) => {
  ...
  return (
    <>
      <div className="w-full fixed inset-0 z-40 backdrop-blur-sm bg-gray-100 bg-opacity-40">
        <div className="flex justify-center">
          <div
            className={` ${fadeEffect} w-full max-w-[800px] mt-20 h-[600px] overflow-y-scroll scrollbar-hide rounded-md text-black shadow-lg relative bg-white`}
          >
